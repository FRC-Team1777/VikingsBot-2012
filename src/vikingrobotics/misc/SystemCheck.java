...
public class SystemCheck extends CommandGroup implements Constants {
	...
	public SystemCheck() {
		...
		addSequential(new GrabberRun(1));
		addSequential(new PrintCommand("[SystemCheck] Grabber Reverse"));
		addSequential(new GrabberReverse(1));
		...
		addSequential(new ShooterRun(0.384), 3);
		...
		addSequential(new ShooterMove(kShooterUp, 1));
		addSequential(new PrintCommand("[SystemCheck] Shooter Down"));
		addSequential(new ShooterMove(kShooterDown, 1));
		addSequential(new WaitCommand(1));
		
		// Arm
		addSequential(new PrintCommand("[SystemCheck] Arm Run"));
		addSequential(new ArmRun(2));
		addSequential(new WaitCommand(1));
